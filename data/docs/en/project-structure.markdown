...
message moves through the system, see [`AGENTS.md`](https://github.com/ziyan/teanode/blob/main/AGENTS.md).
...
into a `GET`. [`docs/subsystems/contacts.md`](https://github.com/ziyan/teanode/blob/main/docs/subsystems/contacts.md) and [`docs/subsystems/calendar.md`](https://github.com/ziyan/teanode/blob/main/docs/subsystems/calendar.md)
...
[`docs/reference/command-line.md`](/doc/command-line), and [`docs/decisions/20260903-two-binaries.md`](https://github.com/ziyan/teanode/blob/main/docs/decisions/20260903-two-binaries.md)
...
[`docs/decisions/20260818-dns-verification-is-advisory.md`](https://github.com/ziyan/teanode/blob/main/docs/decisions/20260818-dns-verification-is-advisory.md).
...
connection. [`docs/subsystems/devices.md`](https://github.com/ziyan/teanode/blob/main/docs/subsystems/devices.md) has the protocol and the rules.
