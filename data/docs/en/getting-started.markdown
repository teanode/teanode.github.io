...
**[reference/deployment.md](https://github.com/ziyan/teanode/blob/main/docs/reference/deployment.md)**, which replaces steps 1
...
- **[configuration.md](/doc/configuration)** documents every field.
- **[reference/command-line.md](/doc/command-line)** covers the CLI,
  which reaches the whole API and is the better tool for anything repetitive.
- **[reference/deployment.md](https://github.com/ziyan/teanode/blob/main/docs/reference/deployment.md)** is this same server
