...
Start with [`docs/reference/local-development.md`](/doc/local-development) to get a build and a database.
...
a word — in [`docs/coding/frontend-design.md`](https://github.com/ziyan/teanode/blob/main/docs/coding/frontend-design.md). Read it before adding a page or
...
- **Every migration ships a matching `.reverse.sql`.** The migration runner in
  ...
  See [`docs/coding/database-migrations.md`](https://github.com/ziyan/teanode/blob/main/docs/coding/database-migrations.md).
...
authentication or certificate issuance. [`SECURITY.md`](/doc/security) says where it goes:
